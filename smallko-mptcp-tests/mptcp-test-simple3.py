...
if '__main__' == __name__:
    ...
    h1.cmd("ifconfig h1-eth2 10.0.4.2 netmask 255.255.255.0")
...
#here now
    ...
    h1.cmd("ip rule add from 10.0.4.2 table 3")
    ...
    h1.cmd("ip route add 10.0.4.0/24 dev h1-eth2 scope link table 3")
    h1.cmd("ip route add default via 10.0.4.1 dev h1-eth2 table 3")
